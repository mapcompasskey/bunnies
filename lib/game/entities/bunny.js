...
.defines(function() {
    EntityBunny = ig.Entity.extend({
        ...
        health: 2,
        maxHealth: 2,
        animSheet: new ig.AnimationSheet('media/bunny.png', 75, 75),
        ...
        prepareEntity: function() {
            ...
            // set randomized speed: 300 - 600
            this.speed = Math.floor((Math.random() * 300) + 300);
            
            // reset parameters
            this.maxVel = {x: 800, y: 800};
        ...
        receiveDamage: function(amount, from) {
            ...
            // apply knockback
            this.vel.x = (from.flip ? -600 : 600);
            this.vel.y = -450;
            
            // if dead
            if (this.health <= 0)
            {
                ig.game.bunnyKillCounter++;
